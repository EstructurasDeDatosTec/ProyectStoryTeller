...
public class AVLTree {
    ...
    private AVLNode insert(String pTag, AVLNode pNode)
    {
        if (pNode == null)
            pNode = new AVLNode(pTag);
        else if (pTag.compareTo((String) pNode.getData()) < 0 )
        {
            pNode.setLeft(insert( pTag, pNode.getLeft() ));
        ...
        {
            pNode.setRight( insert( pTag, pNode.getRight() ));
